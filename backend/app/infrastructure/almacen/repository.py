...
def _listar_productos(tipo_producto: Optional[str]=None, busqueda: Optional[str]=None, activo: Optional[str]=None, _current_user: CurrentUser | None = None, limit: int=100, offset: int=0):
...
def _listar_servicios(busqueda: Optional[str]=None, activo: Optional[str]=None, categoria: Optional[str]=None, _current_user: CurrentUser | None = None, limit: int=100, offset: int=0):
...
def _listar_comodatos(estatus: Optional[str]=None, busqueda: Optional[str]=None, _current_user: CurrentUser | None = None, limit: int=100, offset: int=0):
