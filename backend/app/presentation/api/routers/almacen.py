...
def obtener_producto(id_producto: int, current_user: Annotated[dict, Depends(get_current_user)] = None):
...
def crear_producto(data: ProductoCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR', 'ENCARGADO_ALMACEN'))] = None):
    return service.crear_producto(data, current_user)

@router.put('/productos/{id_producto}', response_model=ProductoResponse)
def actualizar_producto(id_producto: int, data: ProductoCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR', 'ENCARGADO_ALMACEN'))] = None):
    return service.actualizar_producto(id_producto, data, current_user)

@router.delete('/productos/{id_producto}')
def desactivar_producto(id_producto: int, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR'))] = None):
...
def ajustar_existencia(id_producto: int, data: AjusteExistenciaRequest, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR', 'ENCARGADO_ALMACEN'))] = None):
...
def obtener_servicio(id_servicio: int, current_user: Annotated[dict, Depends(get_current_user)] = None):
...
def crear_servicio(data: ServicioCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR'))] = None):
    return service.crear_servicio(data, current_user)

@router.put('/servicios/{id_servicio}', response_model=ServicioResponse)
def actualizar_servicio(id_servicio: int, data: ServicioCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR'))] = None):
    return service.actualizar_servicio(id_servicio, data, current_user)

@router.delete('/servicios/{id_servicio}')
def desactivar_servicio(id_servicio: int, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR'))] = None):
...
def obtener_comodato(id_comodato: int, current_user: Annotated[dict, Depends(get_current_user)] = None):
...
def crear_comodato(data: ComodatoCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR', 'ENCARGADO_ALMACEN'))] = None):
    return service.crear_comodato(data, current_user)

@router.put('/comodatos/{id_comodato}', response_model=ComodatoResponse)
def actualizar_comodato(id_comodato: int, data: ComodatoCreate, current_user: Annotated[dict, Depends(require_role('ADMINISTRADOR', 'ENCARGADO_ALMACEN'))] = None):
...
@router.get('/stats')
def almacen_stats(current_user: Annotated[dict, Depends(get_current_user)] = None):
