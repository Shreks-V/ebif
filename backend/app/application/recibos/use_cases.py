...
class RecibosService:
    ...
    def listar_ventas(self, fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None, id_paciente: Optional[int] = None, search: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0, solo_adeudos: bool = False):
    ...
    def cancelar_venta(self, id_venta: int, motivo: Optional[str] = None, current_user: CurrentUser | None = None):
...
def listar_ventas(fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None, id_paciente: Optional[int] = None, search: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0, solo_adeudos: bool = False):
