...
class BeneficiariosService:
    ...
    def listar_tipos_espina(self, current_user: dict = None):
        return self._repository.listar_tipos_espina(current_user)

    def stats_beneficiarios(self, current_user: dict = None):
        return self._repository.stats_beneficiarios(current_user)

    def dashboard_stats(self, current_user: dict = None):
        return self._repository.dashboard_stats(current_user)

    def listar_beneficiarios(self, nombre: Optional[str] = None, estado: Optional[str] = None, genero: Optional[str] = None, busqueda: Optional[str] = None, membresia_estatus: Optional[str] = None, tipo_cuota: Optional[str] = None, current_user: dict = None, limit: int = 100, offset: int = 0):
    ...
    def obtener_beneficiario(self, folio: str, current_user: dict = None):
        return self._repository.obtener_beneficiario(folio, current_user)

    def crear_beneficiario(self, data: BeneficiarioCreate, current_user: dict = None):
        return self._repository.crear_beneficiario(data, current_user)

    def actualizar_beneficiario(self, folio: str, data: BeneficiarioCreate, current_user: dict = None):
        return self._repository.actualizar_beneficiario(folio, data, current_user)

    def eliminar_beneficiario(self, folio: str, current_user: dict = None):
        return self._repository.eliminar_beneficiario(folio, current_user)

    def historial_beneficiario(self, folio: str, current_user: dict = None, limit_citas: int = 100, offset_citas: int = 0, limit_pagos: int = 100, offset_pagos: int = 0, limit_comodatos: int = 100, offset_comodatos: int = 0):
    ...
    def listar_membresias_proximas_a_vencer(self, dias: int = 30, current_user: dict = None, limit: int = 500, offset: int = 0):
        return self._repository.listar_membresias_proximas_a_vencer(dias, current_user, limit, offset)

    def renovar_membresia(self, folio: str, data: dict, current_user: dict = None):
...
def historial_beneficiario(folio: str, current_user: dict = None, limit_citas: int = 100, offset_citas: int = 0, limit_pagos: int = 100, offset_pagos: int = 0, limit_comodatos: int = 100, offset_comodatos: int = 0):
