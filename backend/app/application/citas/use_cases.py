...
class CitasService:
    ...
    def listar_citas(self, fecha: str | None = None, estatus: str | None = None, id_paciente: int | None = None, busqueda: str | None = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
...
def listar_citas(fecha: str | None = None, estatus: str | None = None, id_paciente: int | None = None, busqueda: str | None = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
