...
class CitasService:
    ...
    def citas_stats(self, current_user: dict = None):
        return self._repository.citas_stats(current_user)

    def citas_hoy(self, current_user: dict = None):
        return self._repository.citas_hoy(current_user)

    def listar_citas(self, fecha: Optional[str] = None, estatus: Optional[str] = None, id_paciente: Optional[int] = None, busqueda: Optional[str] = None, current_user: dict = None, limit: int = 100, offset: int = 0):
        return self._repository.listar_citas(fecha, estatus, id_paciente, busqueda, current_user, limit, offset)

    def obtener_cita(self, id_cita: int, current_user: dict = None):
        return self._repository.obtener_cita(id_cita, current_user)

    def crear_cita(self, data: CitaCreate, current_user: dict = None):
        return self._repository.crear_cita(data, current_user)

    def actualizar_cita(self, id_cita: int, data: CitaCreate, current_user: dict = None):
        return self._repository.actualizar_cita(id_cita, data, current_user)

    def completar_cita(self, id_cita: int, current_user: dict = None):
        return self._repository.completar_cita(id_cita, current_user)

    def cancelar_cita(self, id_cita: int, current_user: dict = None):
        return self._repository.cancelar_cita(id_cita, current_user)

    def eliminar_cita(self, id_cita: int, current_user: dict = None):
        return self._repository.eliminar_cita(id_cita, current_user)

    def citas_proximas(self, dias: int = 7, current_user: dict = None):
