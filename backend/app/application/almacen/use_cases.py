...
class AlmacenService:
    ...
    def listar_productos(self, tipo_producto: Optional[str] = None, busqueda: Optional[str] = None, activo: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
    ...
    def listar_servicios(self, busqueda: Optional[str] = None, activo: Optional[str] = None, categoria: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
    ...
    def listar_comodatos(self, estatus: Optional[str] = None, busqueda: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
    ...
    def listar_movimientos(self, id_producto: Optional[int] = None, tipo_movimiento: Optional[str] = None, busqueda: Optional[str] = None, fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
...
def listar_movimientos(id_producto: Optional[int] = None, tipo_movimiento: Optional[str] = None, busqueda: Optional[str] = None, fecha_inicio: Optional[str] = None, fecha_fin: Optional[str] = None, current_user: CurrentUser | None = None, limit: int = 100, offset: int = 0):
